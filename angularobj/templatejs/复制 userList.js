...
//								'<td>用户分类</td>'+	
    ...
    jQuery(document).on('click','.tcdPageCode2 .tcdNumber',function(){
    	alert(jQuery(this).html());    		//showPage1(jQuery(this).html(),jQuery('.showNum').find('option:selected').val(),jQuery('.search').val());
    })
    var pagesIndex,nextPage;
    //上一页
     jQuery(document).on('click','.tcdPageCode2 .prevPage',function(){
...
//  //下一页
    jQuery(document).on('click','.tcdPageCode2 .nextPage',function(){
